...
export default function RouteHeader({ active }: { active: "shop" | "orders" | "account" }) {
  return <>
    ...
    <header className="header">
      ...
      <div className="header-actions"><span className="location"><span>⌖</span> Quezon City <b>⌄</b></span><Link className="icon-button" href="/account">♙</Link><Link className="cart-button" href="/checkout"><span>Cart</span><b>0</b></Link></div>
    </header>
  </>;
}
